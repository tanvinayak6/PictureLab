...
public class Picture extends SimplePicture 
{
  ...
  public void grayscale()
  {
    ...
    for( int i = 0; i<pixels.length; i++)
    {
      ...
      {
        int avg = (pixels[i][j].getBlue() + pixels[i][j].getRed() + pixels[i][j].getGreen())/3;
  ...
  public void myCollage(Picture x,  Picture y, Picture a){
    x.keepOnlyBlue();
    x.copy(x, 100, 100);
    y.mirrorHorizontal();
    x.copy(y, 50, 50);
